...
class UMODSEDITOR_API IUModsEditor : public IModuleInterface
{
...
public:
	...
	void ModsButtonCreated(class FToolBarBuilder& ToolBarBuilder);
	void ModsButtonReleased();
	TSharedRef<SDockTab> ModsDockTabCreated(const FSpawnTabArgs& SpawnTabArgs);
...
private:
	...
	TSharedPtr<class FSlateStyleSet> SlateStyleSetPtr = nullptr;
	TSharedPtr<class FUICommandList> UICommandListPtr = nullptr;
