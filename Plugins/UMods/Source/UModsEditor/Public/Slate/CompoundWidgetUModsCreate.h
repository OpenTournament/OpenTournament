...
#include "Slate/CompoundWidgetUMods.h"

class SCompoundWidgetUModsCreate : public SCompoundWidgetUMods
{

	struct FPluginDescriptor* PluginDescriptor = nullptr;

public:

	SLATE_BEGIN_ARGS(SCompoundWidgetUModsCreate){}
	SLATE_END_ARGS()

	void Construct(const FArguments& InArgs);

	virtual void Execute(FString Command) override {}

	virtual void OnButtonReleased() override;

	void OnSelected(FString Text);
