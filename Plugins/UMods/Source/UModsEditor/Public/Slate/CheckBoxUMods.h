...
class SCheckBoxUMods : public SCheckBox
{

public:
	
	SLATE_BEGIN_ARGS(SCheckBoxUMods) {}
	SLATE_END_ARGS()
	...
	DECLARE_DELEGATE_OneParam(FOnSelectedDelegate, FString)

	FOnSelectedDelegate OnSelected;

	void OnSelectedInternal(ECheckBoxState State);
