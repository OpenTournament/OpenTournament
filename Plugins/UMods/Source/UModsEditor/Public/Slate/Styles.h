...
public:
	...
	static FMargin GetBlockPadding();

	// ---------------------------------------------------------------------------
	//		FStyles - Color
	// ---------------------------------------------------------------------------

	static FLinearColor GetColorNone();
	static FLinearColor GetColorBlack();
	static FLinearColor GetColorGreyLight();
	static FLinearColor GetColorGreyMedium();
	static FLinearColor GetColorGreyDark();
	static FLinearColor GetColorGreen();

	// ---------------------------------------------------------------------------
	//		FStyles - Margin
	// ---------------------------------------------------------------------------

	static FMargin GetMarginAll();
	static FMargin GetMarginHorizontal();
	static FMargin GetMarginVertical();
	static FMargin GetMarginNone();
	static FMargin GetMarginTop();
	static FMargin GetMarginBottom();
	static FMargin GetMarginLeft();
	static FMargin GetMarginRight();

	// ---------------------------------------------------------------------------
	//		FStyles - Padding
	// ---------------------------------------------------------------------------

	static FMargin GetPaddingAll();
	static FMargin GetPaddingVertical();
	static FMargin GetPaddingHorizontal();
	static FMargin GetPaddingNone();

	// ---------------------------------------------------------------------------
	//		FStyles - Brush
	// ---------------------------------------------------------------------------

	static FSlateBrush* GetBackgroundNone();
	static FSlateBrush* GetBackgroundBlack();
	static FSlateBrush* GetBackgroundGreyLight();
	static FSlateBrush* GetBackgroundGreyMedium();
	static FSlateBrush* GetBackgroundGreyDark();
	static FSlateBrush* GetBackgroundGreen();
	static FSlateBrush* GetBorderGreenAll();
	static FSlateBrush* GetBorderGreenHorizontal();
	static FSlateBrush* GetBorderGreenVertical();
	static FSlateBrush* GetBorderGreenTop();
	static FSlateBrush* GetBorderGreenBottom();
	static FSlateBrush* GetBorderGreenLeft();
	static FSlateBrush* GetBorderGreenRight();
