...
class SCompoundWidgetUModsPackage : public SCompoundWidgetUMods
{

public:

	SLATE_BEGIN_ARGS(SCompoundWidgetUModsPackage) {}
	SLATE_END_ARGS()
	...
	void OnModSelected(FString Text);

	void OnReleaseSelected(FString Text);
