...
CommandContextUMods::CommandContextUMods() : TCommands<CommandContextUMods>(TEXT("UModsEditor"), NSLOCTEXT("Contexts", "UModsEditor", "UMods"), NAME_None, TEXT("UModsEditorStyle"))
{
	// Nothing to do here.
}

void CommandContextUMods::RegisterCommands()
{
#define LOCTEXT_NAMESPACE "UModsEditor"
	UI_COMMAND(OpenMenu, "Mods", "Manage your mods!", EUserInterfaceActionType::Button, FInputGesture());
