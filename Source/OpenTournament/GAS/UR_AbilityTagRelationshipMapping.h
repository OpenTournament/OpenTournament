...
#include "UR_AbilityTagRelationshipMapping.generated.h"
...
USTRUCT()
struct FUR_AbilityTagRelationship
{
    GENERATED_BODY()
...
UCLASS()
class UUR_AbilityTagRelationshipMapping : public UDataAsset
{
    GENERATED_BODY()
...
private:
    ...
    TArray<FUR_AbilityTagRelationship> AbilityTagRelationships;
