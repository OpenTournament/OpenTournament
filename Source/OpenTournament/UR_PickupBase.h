...
public:	
	...
	*/
	...
	TSubclassOf<class ULocalMessage> PickupMessage;
...
public:
	...
	*/
	...
	bool AllowPickupBy(class AActor* Other);
	...
	*/
	UFUNCTION(BlueprintNativeEvent)
	void GiveTo(class AActor* Other);
	...
	*/
	UFUNCTION(BlueprintNativeEvent)
	void SimulateGiveTo(class AActor* LocalClientActor);
