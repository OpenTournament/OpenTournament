...
#include "UR_PenetrationAvoidanceFeeler.generated.h"
 ...
 */
USTRUCT()
struct FUR_PenetrationAvoidanceFeeler
{
    GENERATED_BODY()
    ...
    FUR_PenetrationAvoidanceFeeler()
    ...
    FUR_PenetrationAvoidanceFeeler(const FRotator& InAdjustmentRot,
