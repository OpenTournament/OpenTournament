...
#include "UR_RangedWeaponInstance.generated.h"
...
/**
 * UUR_RangedWeaponInstance
 *
 * A piece of equipment representing a ranged weapon spawned and applied to a pawn
 */
UCLASS()
class UUR_RangedWeaponInstance
    : public UUR_WeaponInstance
    , public IUR_AbilitySourceInterface
{
    GENERATED_BODY()

public:
    UUR_RangedWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
public:
    ...
    //~IUR_AbilitySourceInterface interface
    ...
    //~End of IUR_AbilitySourceInterface interface
