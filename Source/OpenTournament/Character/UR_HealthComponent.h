...
public:
    ...
    static UUR_HealthComponent* FindHealthComponent(const AActor* Actor)
    {
        return (Actor ? Actor->FindComponentByClass<UUR_HealthComponent>() : nullptr);
    }
    ...
    UFUNCTION(BlueprintCallable, Category = "OT|Health")
    EGameDeathState GetDeathState() const
    {
        return DeathState;
    }
    ...
    {
        return (DeathState > EGameDeathState::NotDead);
    }
