...
#include "UR_SafeZoneEditor.generated.h"
...
UCLASS(Abstract)
class UUR_SafeZoneEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
    GENERATED_BODY()
...
public:
    UUR_SafeZoneEditor(const FObjectInitializer& Initializer);
